...
$(document).ready(function () {
  var pageNumber = $('.js-answer-id').attr('data-id');
  var testId = $('.js-test-id').val();
  var savedAnswer = localStorage.getItem(pageNumber);
  ...
  $('.js-next-button').on('click', function (event) {
    var radioValue = $('input[name="answerId"]:checked').val();
  ...
  $('form').on('submit', function () {
    Object.keys(localStorage).forEach(function (key) {
      if ($.isNumeric(key)) {
        ...
        $('.js-answers').prepend('' + '<input type="hidden" id="answer' + key + '" value="' + value + '" name="answerIds[]">');
      }
    });
    localStorage.clear();
  });
  ...
  if (storageLength) {
    ...
    var answeredQuestions = storageLength - 1;
    $('.js-unfinished').prepend('' + '<div class="card-body">' + '<h5 class="card-title">Continue your unfinished test!</h5>' + '<p class="card-text">You have unfinished your test ' + answeredQuestions + '/10 questions answered</p>' + '<a href="test/' + id + '?page=' + answeredQuestions + '" class="btn btn-primary">Continue</a>' + '</div>');
  }

  $('.table-answers tr').each(function (index, cell) {
    var points = $(cell).children('.js-points').attr('data-id');
    var answer = $(cell).children('.js-correct').attr('data-id');
